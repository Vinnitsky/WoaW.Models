<template >
    <!-- START Sidebar (left)-->
    <div id="leftSidePanel" class="aside-inner">
        <nav data-sidebar-anyclick-close="" class="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="nav-heading ">
                    <span data-localize="sidebar.heading.MAIN"></span>
                </li>
                <li class=" ">
                    <a href="#mainView" title="Main View" data-toggle="collapse">
                        <div class="pull-right label label-info">3</div>
                        <em class="icon-speedometer"></em>
                        <span data-localize="sidebar.nav.MAINVIEW">Main View</span>
                    </a>
                    <ul id="mainView" class="nav sidebar-subnav collapse">
                ...
                <li class=" ">
                    <a href="#products" title="Products" data-toggle="collapse">
                        <div class="pull-right label label-info">3</div>
                        <em class="icon-speedometer"></em>
                        <span data-localize="sidebar.nav.PRODUCTS.Header">Products</span>
                    </a>
